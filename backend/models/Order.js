  ...
  devices: [
    {
      ...
      name: { type: String, required: true, default: "Device" },
      brand: { type: String, required: true, default: "Apple" },
      category: { type: String, required: true, default: "mobile" },
      selectedStorage: { type: String, required: true, default: "Standard" },
      selectedColor: { type: String, required: true, default: "Standard" },
      selectedCondition: { type: String, required: true, default: "Good" },
